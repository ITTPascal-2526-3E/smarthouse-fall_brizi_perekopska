...
namespace BlaisePascal.SmartHouse.Domain.UnitTests.IlluminationTests
{
    ...
    public class LampTests
    {
        ...
        {
            byte brightness = 101;
            var Lamp = new Lamp("aaa", true, brightness , [0,0,0],"Led",new Time(11,11,11),new Time(11,11,11));
        ...
        {
            bool isOn = false;
            var lamp = new Lamp("aaa", isOn, brightness: 50, color: new byte[] { 255, 0, 0 }, type: "LED", onTime: new Time(18, 0,2), offTime: new Time(6, 0,5));
        ...
        {
            bool isOn = true;
            var lamp = new Lamp("aaa", isOn, brightness: 70, color: new byte[] { 0, 0, 255 }, type: "Incandescent", onTime: new Time(20, 0, 4), offTime: new Time(8, 0, 7));
        ...
        {
            bool isOn = false;
            var lamp = new Lamp("aaa", isOn, brightness: 60, color: new byte[] { 255, 255, 0 }, type: "CFL", onTime: new Time(17, 0,1), offTime: new Time(5, 0,4));
